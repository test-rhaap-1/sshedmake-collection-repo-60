"""A hello-world filter plugin in sshedmake_namespace_60.myrhdh_60."""
...
DOCUMENTATION = """
    name: hello_world
    author: Sshedmake_namespace_60 Myrhdh_60
    version_added: "1.0.0"
...
- name: Display a hello message
  ansible.builtin.debug:
    msg: "{{ 'ansible-creator' | sshedmake_namespace_60.myrhdh_60.hello_world }}"
"""
